    ...
    <div className="max-w-5xl mx-auto">
      ...
      {styles.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-800 mb-2">暂无保存的风格</h3>
          <p className="text-gray-600 mb-6">请先在首页添加视频文案来提取风格</p>
          <button
            onClick={() => router.push('/')}
              ...
              >
                ...
                {expandedStyle === style.id && (
                  <div className="mt-3 pt-3 border-t border-gray-100">
                    <div className="text-sm text-gray-600 max-h-60 overflow-y-auto whitespace-pre-wrap">
                      {style.styleAnalysis}
                    </div>
                  </div>
                )}
